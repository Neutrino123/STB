...
static constexpr auto qt_meta_stringdata_ZN12RegisterPageE = QtMocHelpers::stringData(
    "RegisterPage",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12RegisterPageE[] = {
...
Q_CONSTINIT const QMetaObject RegisterPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12RegisterPageE.offsetsAndSizes,
    qt_meta_data_ZN12RegisterPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12RegisterPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *RegisterPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12RegisterPageE.stringdata0))
