...
static constexpr auto qt_meta_stringdata_ZN9MapWindowE = QtMocHelpers::stringData(
    "MapWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9MapWindowE[] = {
...
Q_CONSTINIT const QMetaObject MapWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9MapWindowE.offsetsAndSizes,
    qt_meta_data_ZN9MapWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9MapWindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MapWindow, std::true_type>
    >,
    nullptr
} };
...
void *MapWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9MapWindowE.stringdata0))
