...
static constexpr auto qt_meta_stringdata_ZN12TicketWidgetE = QtMocHelpers::stringData(
    "TicketWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12TicketWidgetE[] = {
...
Q_CONSTINIT const QMetaObject TicketWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12TicketWidgetE.offsetsAndSizes,
    qt_meta_data_ZN12TicketWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12TicketWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TicketWidget, std::true_type>
    >,
    nullptr
} };
...
void *TicketWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12TicketWidgetE.stringdata0))
